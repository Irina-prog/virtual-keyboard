const layouts = {
  ...
  en: [
    ...
    [{ key: 'shift', code: 'ShiftLeft' }, { shift: '~', key: '`', code: 'IntlBackslash' }, 'z', 'x', 'c', 'v', 'b', 'n', 'm', { key: '▲', code: 'ArrowUp' }, { shift: '<', key: ',', code: 'Comma' }, { shift: '>', key: '.', code: 'Period' }, { shift: '/', key: '?', code: 'Slash' }, { key: 'shift', code: 'ShiftRight' }],
